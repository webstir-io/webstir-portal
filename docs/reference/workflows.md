...
- `add-route <name> [--method <METHOD>] [--path <path>] [--fastify]`: add a backend API route to `webstir.moduleManifest.routes` and optionally scaffold/register a Fastify handler (SSG/page metadata belongs in `webstir.moduleManifest.views`).
...
- Testing — [tests](../explanations/testing.md) and the [orchestrator testing guide](https://github.com/webstir-io/webstir-dotnet/blob/main/.codex/testing.md)
