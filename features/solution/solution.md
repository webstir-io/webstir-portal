...
## Organization
- [CLI](cli/cli.md): Command entrypoint and help text. Wires DI and invokes workflows.
- [Engine](engine/engine.md): Core logic and pipelines.
...
See also: [CLI reference](cli/cli.md)
