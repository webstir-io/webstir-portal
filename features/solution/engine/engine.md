...
## Structure
- Workflows — high‑level orchestration: [workflows](../../workflows/workflows.md)
- Pipelines — HTML, CSS, JS/TS stages: [pipelines](../../pipelines/pipelines.md)
...
See details in [pipelines](../../pipelines/pipelines.md).
...
See [dev service](../../devservice/devservice.md) for behavior and lifecycle.
...
## Testing
- Favor end‑to‑end workflow tests over unit tests. See [testing](../../testing/testing.md) and [.codex/testing.md](../../../../../.codex/testing.md).
