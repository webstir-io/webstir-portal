...
Detailed reference for the `webstir` CLI. This expands the high‑level overview in [solution.md](../solution.md) and focuses on concrete behavior, options, and outputs.
