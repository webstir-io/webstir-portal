...
4. Test (`webstir test`)
   - Builds, ensures the bundled `@webstir/test` tools are installed, then runs the `webstir-test` CLI to execute compiled frontend and backend suites; reports pass/fail summary.
