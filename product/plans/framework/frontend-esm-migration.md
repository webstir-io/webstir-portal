...
## Goals
- Raise the minimum supported runtime to Node.js 20 across CLI, tests, and embedded tarballs.
...
### Dependency Audit
- Confirm third-party packages (e.g., `sharp`, `glob`, `commander`) provide ESM builds compatible with Node 20.
- Replace or shim any CommonJS-only dependencies that block ESM or provide guidance for dual mode if necessary.
